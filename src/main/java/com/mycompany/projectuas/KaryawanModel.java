...
public class KaryawanModel {
    ...
    public void   setJenisKelamin(String v)      { jenisKelamin.set(v); }
    ...
    public void   setNoHp(String v)              { noHp.set(v); }

    // ── tanggalMasuk ──────────────────────────────────────
    public StringProperty tanggalMasukProperty() { return tanggalMasuk; }
    public String getTanggalMasuk()              { return tanggalMasuk.get(); }
    public void   setTanggalMasuk(String v)      { tanggalMasuk.set(v); }

    // ── statusKerja ───────────────────────────────────────
    public StringProperty statusKerjaProperty()  { return statusKerja; }
    public String getStatusKerja()               { return statusKerja.get(); }
    public void   setStatusKerja(String v)       { statusKerja.set(v); }
