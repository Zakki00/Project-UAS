...
public class AbsensiModel {
    ...
    // ── idAbsensi ─────────────────────────────────────────
    public IntegerProperty idAbsensiProperty()       { return idAbsensi; }
    public int    getIdAbsensi()                     { return idAbsensi.get(); }
    public void   setIdAbsensi(int v)                { idAbsensi.set(v); }

    // ── idKaryawan ────────────────────────────────────────
    public StringProperty idKaryawanProperty()       { return idKaryawan; }
    public String getIdKaryawan()                    { return idKaryawan.get(); }
    public void   setIdKaryawan(String v)            { idKaryawan.set(v); }

    // ── namaKaryawan ──────────────────────────────────────
    public StringProperty namaKaryawanProperty()     { return namaKaryawan; }
    public String getNamaKaryawan()                  { return namaKaryawan.get(); }
    public void   setNamaKaryawan(String v)          { namaKaryawan.set(v); }
    ...
    public void   setTanggal(String v)               { tanggal.set(v); }

    // ── shiftMasuk ────────────────────────────────────────
    public StringProperty shiftMasukProperty()       { return shiftMasuk; }
    public String getShiftMasuk()                    { return shiftMasuk.get(); }
    public void   setShiftMasuk(String v)            { shiftMasuk.set(v); }
    ...
    public void   setStatusKehadiran(String v)       { statusKehadiran.set(v); }
}