...
public class DashboardController implements Initializable {
    ...
    /** Fade-in node dari opacity 0 ke 1 */
    ...
    /** Fade-in + scale-up (cocok untuk card/pie chart) */
    ...
    /** Animasi progress bar dari 0 ke nilai akhir */
    ...
    // ═══════════════════════════════════════════════════════
    // SETUP CHARTS — urutan sesuai tampilan dashboard
    // ═══════════════════════════════════════════════════════
    private void setupCharts() {
        // Row 1 (atas): pie piutang | terlaris minggu ini | rata-rata line
        loadPiePiutang();
        loadTerlarisMingguIni();
        loadLineRataRata();

        // Row 2: grafik penjualan area | transaksi/hari bar
        setupSalesChart();
        setupTrxChart();

        // Row 3: top produk bar | top ps bar | tren 6 bulan | stok menipis
        loadBarChart();
        loadBarChartPs();
        setupMonthChart();
        setupStockList();

        // Row 4: komposisi pie | omzet kategori | transaksi per jam
